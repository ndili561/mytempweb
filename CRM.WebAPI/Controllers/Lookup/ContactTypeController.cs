...
namespace CRM.WebAPI.Controllers.Lookup
{
    ...
    public class ContactTypeController  : BaseController<BaseEntity>
    {
        private readonly IContactTypeService _addressTypeService;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]ContactTypeDto addressType)
        {
            if (addressType.Id != 0)
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody]ContactTypeDto addressType)
        {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            return await DeleteAsync(
                async () => await _addressTypeService.ContactTypeExistsAsync(id),
